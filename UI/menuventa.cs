    ...
    public class MenuVentas
    {
        ...
        private async Task ListarVentas()
        {
            ...
            try
            {
                ...
                if (!ventas.Any())
                {
                    MenuPrincipal.MostrarMensaje("\nNo hay ventas registradas.", ConsoleColor.Yellow);
                }
                else
                {
                    ...
                    foreach (var venta in ventas)
                    {
                        Console.WriteLine("{0,-10} {1,-12} {2,-20} {3,-20} {4,-15}", 
                            ...
                            venta.Cliente?.NombreCompleto.Length > 17 
                                ? venta.Cliente.NombreCompleto.Substring(0, 17) + "..." 
                                : venta.Cliente?.NombreCompleto,
                            venta.Empleado?.NombreCompleto.Length > 17 
                                ? venta.Empleado.NombreCompleto.Substring(0, 17) + "..." 
        ...
        private async Task VerDetalleVenta()
        {
            ...
            try
            {
                ...
                if (venta == null)
                {
                    MenuPrincipal.MostrarMensaje("\nLa venta no existe.", ConsoleColor.Yellow);
                }
                else
                {
                    ...
                    Console.WriteLine($"Cliente: {venta.Cliente?.NombreCompleto}");
                    Console.WriteLine($"Empleado: {venta.Empleado?.NombreCompleto}");
        ...
        private async Task RegistrarVenta()
        {
            ...
            try
            {
                ...
                {
                    MenuPrincipal.MostrarMensaje("\nNo hay planes promocionales vigentes.", ConsoleColor.Yellow);
                }
                ...
                foreach (var detalle in venta.Detalles)
                {
                    ...
                    if (descuentosPorProducto.ContainsKey(detalle.ProductoId))
                    {
                        nombreProducto += " (P)";
                    }
